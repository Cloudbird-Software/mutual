...
- 缩放律：同集协会 per-profile ≈ N/4~N/2；二部 ≈ N/8 已足。
- 已落地：config budgets 24→48 / 1200→4800（commit 3c17fe9）。
...
| N | HR@3(cap 适配后) | edges | envy | 耗时 |
|---|---|---|---|---|
| 50 | 1.000 | 97 | 0 | 143ms |
| 100 | 1.000 | 196 | 0 | 341ms |
| 200 | 0.970 | 394 | 0 | 1.7s |
| 800（近似管线） | 0.907-0.995 | ~1600 | rate≈20 | ~40s |
